...
class JointStatesPublisher:
    def __init__(self):
        ...
        self.cartesian_states_pub = rospy.Publisher(
            "/robot_cartesian_state", Pose, queue_size=10
        )
    ...
    def publish_joint_states(self):
        ...
        joint_state_msg.position = arm_pos.tolist() + [
            gripper_pos * 0.8
        ]  # sim/rviz gripper is 0.8x real gripper
